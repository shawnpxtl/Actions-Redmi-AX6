...
4. 如果你此前给AX6刷入了双系统，请输入nvram set flag_last_success=1和nvram set flag_boot_rootfs=1 然后重启设备切换系统（没有的话请点击[参考链接](https://www.right.com.cn/forum/thread-6054985-1-1.html)安装双系统）
5. 通过scp上传后缀为.ubi的固件
